...
export default function CartSummaryItem(props) {
  ...
  return (
    <div className='d-flex img-thumbnail m-3 pt-3 pb-3'>
      <div className='cart-img-container text-center d-flex align-items-center'>
        <img className='product-detail-img img-fluid cart-image' src={props.cartItems ? image : 'No product found'} alt={name} />
      </div>
      <div className='cart-item-desc d-flex flex-column justify-content-start pl-2 pt-2 pr-2'>
